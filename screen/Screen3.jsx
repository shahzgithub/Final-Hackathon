...
export const Screen3 = (props) => {
  ...
  return (
    <View>
      <View>
        <Image source={require('../assets/Img2.jpeg')} style={styles.img} />
      </View>
      ...
      <View style={styles.container}>
        ...
        <View style={{width:'100%',flexDirection:'row',justifyContent:'space-around',marginTop:30,}} >
          ...
          <TouchableOpacity onPress={() => props.navigation.navigate('Screen4')} style={{backgroundColor:'#6756FF',padding:10,borderRadius:100,}}>
            <Text>
              <AntDesign style={{
              textAlign: 'center',
              fontSize: 30,
